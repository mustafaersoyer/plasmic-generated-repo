...
import sty from "./PlasmicButton.module.css"; // plasmic-import: CQz12hwjK3UdWi/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__nrjx6)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__hAVtj)}
                role={"img"}
              />
            ),
